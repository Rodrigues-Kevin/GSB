...
public class biodataController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        colId.setCellValueFactory(
                (TableColumn.CellDataFeatures<modelBiodata, String> cellData) -> cellData.getValue().idProperty());
        colNom.setCellValueFactory(
                (TableColumn.CellDataFeatures<modelBiodata, String> cellData) -> cellData.getValue().nomProperty());
        colAdresse.setCellValueFactory(
                (TableColumn.CellDataFeatures<modelBiodata, String> cellData) -> cellData.getValue().adresseProperty());
