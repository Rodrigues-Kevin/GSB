...
/**
 * Création de ma classe implBiodata qui implémente l'interface interBiodata
 * permettant de redéfinir le CRUD (les méthodes déclarées dans l'interface)
 */
...
public class implBiodata implements interBiodata {
    ...
    public void update(modelBiodata m) {
        ...
        try {
            ps = k.connect()
                    .prepareStatement("update tablebiodata set nom=?, adresse=?, datedenaissance=? where id = ?");
